...
class ProductController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        $grid->column('recommend_flag',_('Recommend Flag'));
        $grid->column('carriage_flag',_('Carriage Flag'));
    ...
    protected function detail($id)
    {
        ...
        $show->field('recommend_flag', _('Recommend Flag'));
        $show->field('carriage_flag', _('Carriage Flag'));
    ...
    protected function form()
    {
        ...
        $form->switch('recommend_flag', _('Recommend Flag'));
        $form->switch('carriage_flag', _('Carriage Flag'));
