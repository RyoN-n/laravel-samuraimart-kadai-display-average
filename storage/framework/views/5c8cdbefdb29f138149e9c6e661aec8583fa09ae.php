         ...
         <div class="col">
             <div class="d-flex flex-column">
                 ...
                 <?php if($product->reviews()->exists()): ?>
                    <p><span class="samuraimart-star-rating" data-rate="<?php echo e(round($product->reviews->avg('score') * 2) / 2, false); ?>"></span>
                    <?php echo e(round($product->reviews->avg('score'), 1), false); ?></p>
                <?php endif; ?>
                 <p class="">
                 ...
                 <div class="row">
                     ...
                     <div class="col-5">
                        <?php if(Auth::user()->favorite_products()->where('product_id', $product->id)->exists()): ?>
                            <a href="<?php echo e(route('favorites.destroy', $product->id), false); ?>" class="btn samuraimart-favorite-button text-favorite w-100" onclick="event.preventDefault(); document.getElementById('favorites-destroy-form').submit();">
                            <i class="fa fa-heart"></i>
                                お気に入り解除
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('favorites.store', $product->id), false); ?>" class="btn samuraimart-favorite-button text-favorite w-100" onclick="event.preventDefault(); document.getElementById('favorites-store-form').submit();">
                                <i class="fa fa-heart"></i>
                                お気に入り
                            </a>
                        <?php endif; ?>
             ...
             <form id="favorites-destroy-form" action="<?php echo e(route('favorites.destroy', $product->id), false); ?>" method="POST" class="d-none">
                <?php echo csrf_field(); ?>
                <?php echo method_field('DELETE'); ?>
             </form>
             <form id="favorites-store-form" action="<?php echo e(route('favorites.store', $product->id), false); ?>" method="POST" class="d-none">
                <?php echo csrf_field(); ?>
             </form>
             <?php endif; ?>
         </div>
         ...
         <div class="offset-1 col-10">
            <div class="row">
                    ...
                    <div class="offset-md-5 col-md-5">
                        ...
                        <p class="h3"><?php echo e($review->title, false); ?></p>
